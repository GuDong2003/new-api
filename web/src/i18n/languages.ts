 ...
 * but `supportedLngs`/resources use the non-standard `zhCN` code. All
 * Chinese variants use Simplified Chinese; unsupported languages fall back to
 * English through i18next's supportedLngs.
 */
