...
export const STATIC_I18N_KEYS = [
  ...
  'The canvas changed. Please try again.',
  'Canvas type does not match this editor.',
  'Invalid canvas name.',
  ...
  'Description mode',
  'Tag mode',
  'Describe the image in a paragraph and let the model handle the details.',
  ...
  'NovelAI generates up to 8 images per request.',
  ...
  // from constant tables at runtime.
  'Non-streaming',
  'Streaming',
  'Tools · non-streaming',
  'Tools · streaming',
  ...
  'No suitable test endpoint was found.',
  ...
  'No valid SSE output was received.',
  'The stream ended without a completion event.',
  'The stream was interrupted.',
  'The stream timed out.',
  'The model output is incomplete.',
  'The model did not complete the output.',
  'The model did not call the test tool.',
