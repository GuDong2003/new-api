...
export const SYSTEM_TASK_TYPE_LABEL: Record<string, string> = {
  ...
  channel_queue_warmup: 'Channel queue warm-up',
  upstream_account_maintenance: 'Upstream account maintenance',
  client_identity_version_refresh: 'Client version refresh',
  database_backup: 'Database backup',
  database_backup_restore: 'Database restore',
}
