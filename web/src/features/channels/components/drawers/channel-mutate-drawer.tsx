...
export function ChannelMutateDrawer({
  ...
  // The editor is a centered dialog, so the redirect window starts at its
  // right edge, where the edit sheet leaves room upstream.
  ...
  const discovery = useChannelModelDiscovery({
    ...
    staticModels:
      currentType === CHANNEL_TYPE_NOVELAI
        ? SUPPORTED_NOVELAI_MODELS
        : undefined,
  })
