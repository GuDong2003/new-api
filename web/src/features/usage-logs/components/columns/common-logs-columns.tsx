                  ...
                  <Tooltip>
                    <TooltipTrigger
                      render={
                        <Link
                          to='/channels'
                          search={{ channel: log.channel }}
                          className='focus-visible:ring-ring flex min-w-0 flex-col items-start gap-0.5 rounded-md text-left outline-none focus-visible:ring-2'
                        />
                      }
                    >
