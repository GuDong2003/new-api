...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/avatar/:filename", controller.GetAvatar)
		...
		apiRouter.POST("/oauth/registration", middleware.CriticalRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, controller.CompleteOAuthRegistration)
		...
		galleryRoute.Use(middleware.DisableCache(), middleware.UserAuth())
		{
			...
			galleryRoute.POST("/original", controller.ReadGalleryOriginal)
