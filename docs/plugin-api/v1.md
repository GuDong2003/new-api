...
The host treats every 2xx upstream status (including 201 Created and 202 Accepted) as a successful submission and passes its status code, headers, and body to `parseSubmitResponse`. Other statuses fail the submission before the hook runs.
