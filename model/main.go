...
` + "`rate_limit_success_count`" + ` integer NOT NULL DEFAULT 0,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "rate_limit_count", DDL: "`rate_limit_count` integer NOT NULL DEFAULT 0"},
		{Name: "rate_limit_success_count", DDL: "`rate_limit_success_count` integer NOT NULL DEFAULT 0"},
