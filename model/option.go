...
func InitOptionMap() {
	...
	common.OptionMap["InviteRegistrationEnabled"] = strconv.FormatBool(common.InviteRegistrationEnabled)
	...
	common.OptionMap["ModelRequestRateLimitGlobalCount"] = strconv.Itoa(setting.ModelRequestRateLimitGlobalCount)
	common.OptionMap["ModelRequestRateLimitGlobalSuccessCount"] = strconv.Itoa(setting.ModelRequestRateLimitGlobalSuccessCount)
...
func validateOptionValue(key string, value string) error {
	...
	if key == operation_setting.ChannelTestMessageOptionKey {
		return operation_setting.ValidateChannelTestMessage(value)
	}
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "InviteRegistrationEnabled":
			common.InviteRegistrationEnabled = boolValue
	...
	case "ModelRequestRateLimitGlobalCount":
		setting.ModelRequestRateLimitGlobalCount, _ = strconv.Atoi(value)
	case "ModelRequestRateLimitGlobalSuccessCount":
		setting.ModelRequestRateLimitGlobalSuccessCount, _ = strconv.Atoi(value)
	case "RetryTimes":
