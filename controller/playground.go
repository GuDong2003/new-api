...
func Playground(c *gin.Context) {
	...
	if relayFormat == types.RelayFormatOpenAIImage {
		// Models a task plugin serves are generated by the plugin; every other
		// model goes through the ordinary relay.
		RelayTaskPluginEndpoint(c, func(c *gin.Context) { Relay(c, relayFormat) })
		return
	}
	Relay(c, relayFormat)
}
